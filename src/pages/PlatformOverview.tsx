...
import { 
  Shield, Eye, FileCheck, Workflow, BarChart3, ArrowRight,
  CheckCircle, Zap, Lock, Settings
} from "lucide-react";
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact"><Button variant="hero" size="xl">Schedule Demo<ArrowRight className="w-5 h-5" /></Button></Link>
        ...
        <section className="py-24 relative">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Platform Modules</h2>
              <p className="text-muted-foreground text-lg">Four integrated components working together to deliver comprehensive security operations.</p>
            </div>
            <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
              {modules.map((module, index) => (
                <ScrollFadeIn key={index} delay={index * 100}>
                  <div className="gem-card gem-border-glow p-8 rounded-2xl group hover:bg-card/80 transition-all duration-300 h-full">
            ...
            <div className="max-w-5xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <ScrollFadeIn direction="left">
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Seamless Integration</h2>
        ...
        <section className="py-24">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto gem-card gem-border-glow p-12 rounded-2xl text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Ready to Transform Your Security Operations?</h2>
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-8">See how GEM Sentinel Trust can provide complete visibility and control over your security posture.</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/contact"><Button variant="hero" size="xl">Request a Demo<ArrowRight className="w-5 h-5" /></Button></Link>
                <Link to="/sentinel-x"><Button variant="hero-outline" size="xl">Learn About Sentinel-X</Button></Link>
              </div>
            </div>
          </div>
        </section>
